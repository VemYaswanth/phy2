...
import RecentProjectsCardThree from "~/components/Ui/Cards/RecentProjectsCardThree";
    ...
    return (
        <div className="tekup-portfolio-section bg-light1 tekup-section-padding-top">
            <div className="container">
                ...
                <Slider  {...settings} >
                    {
                        projects?.map((item, idx) => <RecentProjectsCardThree key={idx} item={item}></RecentProjectsCardThree>)
                    }
                </Slider>
            </div>
